...
{
    public partial class cboAccountType : efComboBox
    {
        private BindingSource bs;
        public cboAccountType()
        {
            InitializeComponent();
        ...
        private List<AccountType> fillBindingsource(AccountingEntities lc) { return lc.AccountTypes.OrderBy(c => c.Description).ToList(); }
        protected override void OnCreateControl()
        {
            ...
            if (!DesignMode)
            {
                using (var lc = new AccountingEntities(App.MainConnectionString))
                {
                    ...
                    Properties.NullValuePrompt = "Select Account Type Or Leave Blank";
